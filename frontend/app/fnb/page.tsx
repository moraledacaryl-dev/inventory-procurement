...
export default function Page(){
 ...
 return <AppShell title="F&B Operations" description="Ingredients, recipes, outlet stock, production, staff meals, food waste, purchasing, receiving, and POS-linked consumption in one focused workspace.">
  ...
  <section className="workspace-launch-grid section-gap">
   ...
   <Link className="card workspace-launch" href="/fnb/staff-meals"><span className="page-kicker">Internal consumption</span><h2>Staff meals</h2><p>Record the actual ingredients used for each daily staff meal, with cost per serving and an auditable reversal trail.</p></Link>
