...
api_router.include_router(property_operations.router)
api_router.include_router(assets.router)
api_router.include_router(pass5_operations.router)
api_router.include_router(pass6_controls.router)
...
api_router.include_router(staff_integrations.router)
