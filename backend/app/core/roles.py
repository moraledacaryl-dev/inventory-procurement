...
ROLE_PERMISSIONS = {
    ...
    Role.INVENTORY_MANAGER: {
        "inventory.*", "items.*", "locations.*", "counts.*", "reports.read",
        "procurement.read", "suppliers.read", "receiving.read",
    },
    Role.PROCUREMENT_OFFICER: {
        "procurement.*", "suppliers.*", "receiving.read", "reports.read",
        "inventory.read", "items.read", "locations.read",
    },
    Role.RECEIVER: {
        "receiving.*", "inventory.read", "procurement.read",
        "items.read", "locations.read", "suppliers.read",
    },
    Role.COUNTER: {
        "counts.create", "counts.submit", "counts.read", "inventory.read",
